...
const getToken = () => {
  return "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzQzODc4NjM2LCJpYXQiOjE3NDMyNzM4MzYsImp0aSI6ImU5ODE3MzE5OTE4YTRmYzk5ZTc5NGJmMjA1ZTQ3NDllIiwidXNlcl9pZCI6ImI0NmQ0MGEyLTllOTktNDdkZi04OGRlLThjYjc2NmU3ZTg5NyJ9.4-GJ5NgPwzI3Xl05TCp60mmitXzAdqpzYI-UnaxLU4w";
};
...
export { generateInsights, createAiGoal, deleteTaskById, createGoal, fetchGoals, fetchAiGoalById, deleteAiGoalById, updateAiGoalById, createTask, createSubtask, fetchTasks, deleteGoalById, updateGoalById, updateAiTaskStatus, updateSingleTaskStatus, updateSubtask, fetchTasksByGoalId, fetchGoalById, fetchUserProfile, deleteAiTaskById, updateAiTaskById, fetchTaskById };